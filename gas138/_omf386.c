...
#line 1 "/MSVC32S/C386/INCLUDE\\stddef.h"
...
#line 27 "/MSVC32S/C386/INCLUDE\\stddef.h"
...
#line 35 "/MSVC32S/C386/INCLUDE\\stddef.h"
	 ...
	 if (symbolP->sy_nlist.n_type & 0340)
	 {
	          ...
	          if (fsymP->sy_nlist.n_type & 0340)
		  {
                     if (fsymP->sy_nlist. n_type & 036) 
		     {
		       ...
		       omf_fixup(1, 1, 
		          9, i * sizeof(struct nlist) + offsetof(struct nlist, n_value), 
    			  external ? 0 : 1,
    			  external ? 5 : frm_thrd,
    			  external ? 0 : 1,
    			  external ? 2 : trgt_thrd,
