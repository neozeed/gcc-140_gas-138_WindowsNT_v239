...
typedef BOOL (APIENTRY *LPOFNHOOKPROC) (HWND, UINT, DWORD, LONG);
...
short APIENTRY     GetFileTitle(LPSTR, LPSTR, WORD);
...
typedef WORD (APIENTRY *LPCCHOOKPROC) (HWND, UINT, DWORD, LONG);
...
typedef BOOL (APIENTRY *LPFRHOOKPROC) (HWND, UINT, DWORD, LONG);
...
typedef BOOL (APIENTRY *LPCFHOOKPROC) (HWND, UINT, DWORD, LONG);
...
typedef int (APIENTRY *LPPRINTHOOKPROC) (HWND, UINT, DWORD, LONG);
typedef int (APIENTRY *LPSETUPHOOKPROC) (HWND, UINT, DWORD, LONG);
